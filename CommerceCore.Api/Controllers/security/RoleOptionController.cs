    ...
    public class RoleOptionController : CustomController
    {
        ...
        public IActionResult GetRoleOption()
        {
            try
            {
                ...
                return Ok(JsonSerializer.Serialize(blServiceSecurity.GetRoleOptions(IdAplication)));
            }
            catch (Exception ex)
            {
        ...
        public IActionResult DeleteRoleOption(int rolOptionId)
        {
            try
            {
                return Ok(JsonSerializer.Serialize(blServiceSecurity.DeleteRoleOption(rolOptionId)));
            }
            catch (Exception ex)
            {
